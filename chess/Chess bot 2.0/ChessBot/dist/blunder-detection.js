 ...
 */
export function checkBlunder(game, move, depth = 3, thresholds = DEFAULT_THRESHOLDS) {
 ...
 */
export function analyzeGameForBlunders(moves, startingFen) {
 ...
 */
export function getBlunderStats(blunders) {
    const stats = {
...
//# sourceMappingURL=blunder-detection.js.map