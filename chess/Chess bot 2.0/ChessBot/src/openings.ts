 ...
 */
export function recognizeOpening(moves: string[]): ChessOpening | null {
 ...
 */
export function getPossibleOpenings(moves: string[]): ChessOpening[] {
 ...
 */
export function startFromOpening(openingName: string): Chess | null {
  const opening = CHESS_OPENINGS.find(o => 
    o.name.toLowerCase() === openingName.toLowerCase()
  );
 ...
 */
export function getOpeningByEco(eco: string): ChessOpening | null {
 ...
 */
export function analyzeOpeningFromGame(moves: string[]) {
 ...
 */
export function getNextOpeningMove(moves: string[], openingName: string): string | null {
  const opening = CHESS_OPENINGS.find(o => 
    o.name.toLowerCase() === openingName.toLowerCase()
  );
